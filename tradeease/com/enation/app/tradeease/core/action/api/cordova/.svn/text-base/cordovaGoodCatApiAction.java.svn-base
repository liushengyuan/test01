...
public class cordovaGoodCatApiAction extends WWAction{
	...
	private String store_cat_ru_name;//俄文
	
	private IGoodsCatManager goodsCatManager;
	
	public String getStoreGoods(Integer cat_id){
	...
	public String addGoodsCat(){
		...
		try {
			...
			storeCat.setStore_cat_ru_name(store_cat_ru_name);
	...
	public String getStore_cat_ru_name() {
		return store_cat_ru_name;
	}
	public void setStore_cat_ru_name(String store_cat_ru_name) {
		this.store_cat_ru_name = store_cat_ru_name;
	}
