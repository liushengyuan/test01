 ...
 */
@Component
public class SellerExpressDetailTag extends BaseFreeMarkerTag {
	...
	protected Object exec(Map params) throws TemplateModelException {
		...
		Integer id = (Integer) params.get("expressId");
		
		SellerExpress express = sellerExpressManager.getSingle(id);
		if(express == null) {
			express = new SellerExpress();
		}
		return express;
	}
