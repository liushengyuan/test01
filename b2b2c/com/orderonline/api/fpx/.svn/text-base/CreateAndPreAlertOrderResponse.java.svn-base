...
/**
 * <p>createAndPreAlertOrderResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="createAndPreAlertOrderResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createAndPreAlertOrderResponse", propOrder = {
    "ack",
    "channelNumber",
    "errors",
    "referenceNumber",
...
public class CreateAndPreAlertOrderResponse {
