...
/**
 * <p>findTrackingNumberService complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="findTrackingNumberService">
 *   &lt;complexContent>
...
@XmlType(name = "findTrackingNumberService", propOrder = {
    "arg0",
    "arg1"
})
public class FindTrackingNumberService {
