...
/**
 * <p>cargoTrackingResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="cargoTrackingResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="tracks" type="{entity.orderonlinetool.api.fpx}track" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "cargoTrackingResponse", propOrder = {
    "ack",
    "errors",
    "referenceNumber",
    "timestamp",
