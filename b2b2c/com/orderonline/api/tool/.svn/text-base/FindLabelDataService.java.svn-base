...
/**
 * <p>findLabelDataService complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="findLabelDataService">
 *   &lt;complexContent>
...
@XmlType(name = "findLabelDataService", propOrder = {
    "arg0",
    "arg1"
})
public class FindLabelDataService {
