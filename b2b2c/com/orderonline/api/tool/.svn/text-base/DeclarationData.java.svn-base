...
/**
 * <p>declarationData complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="declarationData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="cargoType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="diName" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "declarationData", propOrder = {
    "cargoType",
    "diName",
    "totalValue",
    "totalWeight"
...
public class DeclarationData {
     ...
     * This is why there is not a <CODE>set</CODE> method for the diName property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDiName().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getDiName() {
        if (diName == null) {
            diName = new ArrayList<String>();
        }
        return this.diName;
    }
