...
/**
 * <p>findTrackingNumberResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="findTrackingNumberResponse">
 *   &lt;complexContent>
...
@XmlType(name = "findTrackingNumberResponse", propOrder = {
    "ack",
    "channelNumber",
    "errors",
    "referenceNumber",
...
public class FindTrackingNumberResponse {
