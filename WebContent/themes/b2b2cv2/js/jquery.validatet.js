...
(function($){
	...
	var DefLang ={
			...
			validate_fail:'Вы подтверждаете форму в недействительным, проверьте содержимое цветом части.',
			required:'Это поле необходимо заполнить',
			string:'Не содержит специальные символы',
			is_not_int:'Эта опция необходимо для целая цифры',
			is_not_float:'Эта опция необходимо для числа с плавающей точкой',
			is_not_date:'Формат дат не правильно',
			is_not_email:'Email формат не правильно',
			is_not_mobile:'Номер сотового формат не правильно',
			is_not_id_card:'cart not valid...',
			is_not_post_code:'Почтовый индекс формат не правильно',
			is_not_url:'Не эффективно формат адреса',
			is_not_tel_num:'Номер формат не правильно',
			is_not_chinese:'Китайский формат ошибки'
