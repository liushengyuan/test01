...
(function($){
	...
	var DefLang ={
			...
			validate_fail:'Содержание заполнения недействительное， проверьте пожалуйста.',
			required:'Это поле необходимо заполнить',
			string:'не  содержит  специальных символов ',
			is_not_int:'Этот вариант  должен  , как целое  число ',
			is_not_float:'Этот вариант  должен быть  число с плавающей точкой ',
			is_not_date:'не  правильный  формат даты ',
			is_not_email:' не правильный формат  электронной почты ',
			is_not_mobile:'номер телефона  не правильный формат ',
			is_not_id_card:'корзина не действительна.',
			is_not_post_code:'почтовый индекс  не правильный формат ',
			is_not_url:'эффективный  адрес  не  формат ',
			is_not_tel_num:'номер телефона  не правильный формат ',
			is_not_chinese:'Неверный формат '
