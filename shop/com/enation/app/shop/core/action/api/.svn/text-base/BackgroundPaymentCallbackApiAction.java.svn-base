...
@Namespace("/api/shop")
@Action("*backgroundpay-callback")
public class BackgroundPaymentCallbackApiAction extends WWAction {
	...
	public  String execute() {
		try{
			...
			this.json= paymentPlugin.onBackgroundCallBack(ordertype);
	...
	private String[] getPluginid(String url) {
		...
		String pattern = ".*/(\\w+)_(\\w+)_(backgroundpay-callback).do(.*)";
