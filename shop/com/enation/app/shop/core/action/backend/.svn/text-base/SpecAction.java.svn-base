...
public class SpecAction extends WWAction {
	...
	private String[] valueRuArray;
	private String[] imageArray;
	private Integer[] valueIdArray;
	private Integer[] valueRuIdArray;
	...
	private List<SpecValue> fillSpecValueList() {
		...
		if (valueArray != null) {
			for (int i = 0; i < valueArray.length; i++) {
				...
				specValue.setSpec_order(i);
				specValue.setSpec_value_ru(this.valueRuArray[i]);
				if (imageArray != null) {
	...
	public String[] getValueRuArray() {
		return valueRuArray;
	}

	public void setValueRuArray(String[] valueRuArray) {
		this.valueRuArray = valueRuArray;
	}

	public Integer[] getValueRuIdArray() {
		return valueRuIdArray;
	}

	public void setValueRuIdArray(Integer[] valueRuIdArray) {
		this.valueRuIdArray = valueRuIdArray;
	}
