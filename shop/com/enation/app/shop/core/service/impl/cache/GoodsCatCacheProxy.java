...
public class GoodsCatCacheProxy extends AbstractCacheProxy<List<Cat> > implements
	...
	public List<Goods> getGoodsByCatId(Integer catid) {
		...
		return this.goodsCatManager.getGoodsByCatId(catid);
	}
	...
	public List<Goods> getGoodsByCatIdByView(Integer catid) {
		// TODO Auto-generated method stub
		return this.goodsCatManager.getGoodsByCatIdByView(catid);
	}
	...
	public List<Goods> otherLookGoods(Integer catid) {
		// TODO Auto-generated method stub
		return this.goodsCatManager.otherLookGoods(catid);
	}
