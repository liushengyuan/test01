...
public interface IMemberCommentManager {
	 ...
	 * @return
	 */
	public Page getGoodsCommentsByGrade(int goods_id,int page,int pageSize,int type,int grade);
	...
	public void updateField(String string, int i, int commentId,String auditDiscribe);

	public Page searchComments(Map commentsMap, int page, int page2,
			int pageSize, int type);
	/**
	 * 获取商品的评论数量根据商品评论等级（lsy）
	 * @param goods_id
	 * @param grade
	 * @return
	 */
