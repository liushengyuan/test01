...
public class Specification {
	...
	private String spec_name_ru;
	public String getSpec_name_ru() {
		return spec_name_ru;
	}
	public void setSpec_name_ru(String spec_name_ru) {
		this.spec_name_ru = spec_name_ru;
	}
	public String getSpec_memo_ru() {
		return spec_memo_ru;
	}
	public void setSpec_memo_ru(String spec_memo_ru) {
		this.spec_memo_ru = spec_memo_ru;
	}
	private String spec_memo_ru;
