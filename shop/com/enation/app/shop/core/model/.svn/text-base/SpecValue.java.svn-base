...
public class SpecValue {
	...
	private String spec_value_ru;
	
	
	public String getSpec_value_ru() {
		return spec_value_ru;
	}
	public void setSpec_value_ru(String spec_value_ru) {
		this.spec_value_ru = spec_value_ru;
	}
