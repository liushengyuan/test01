...
public class TransUtils {
	...
	public static void main(String[] args) {
		...
		/*String custId="BSPdevelop";
		String checkWord="j8DzkIFgmlomPt0aLuwU";
		String xml2="";
		String verifyCode="";

		xml2="<?xml version=’1.0’ encoding=’UTF-8’?><Request service=’OrderService’ lang=’zh-CN’><Head>” + custId + ”</Head><Body><Order orderid=’201503100001’  express_type='1' ...></Order></Body></Request>";
		byte[] xmlTmp = UTF8.GetBytes(xml2+checkWord);
		byte[] MD5Tmp= md5Encrypt(xmlTmp);
		verifyCode=Base64(MD5Tmp);
		callService ( xml , verifyCode ) ;*/
