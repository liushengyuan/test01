...
public abstract class SortContainer {
	...
	public static  List<Map<String,String>> getSortList(){
		...
		sort_buynum.put("name_ru", "Продажи");
		sort_buynum.put("name_en", "Sales");
		...
		sort_price.put("name_ru", "Цена");
		sort_price.put("name_en", "Price");
		...
		sort_grade.put("name_ru", "Оценки");
		sort_grade.put("name_en", "Appraisal");
