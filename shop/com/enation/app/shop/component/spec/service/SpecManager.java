...
public class SpecManager extends BaseSupport<Specification>  implements ISpecManager {
	...
	public List<Specification> listSpecAndValue(){
		...
		sql ="select * from spec_values order by spec_id ,spec_order";
	...
	public List getProSpecList(int productid) {
		String sql ="select s.spec_name name ,s.spec_name_ru name_ru ,sv.spec_value value,sv.spec_value_ru value_ru  from   "+this.getTableName("specification")+" s ,"+this.getTableName("spec_values")+" sv ,"+this.getTableName("goods_spec")+" gs where gs.product_id=? and gs.spec_id=s.spec_id and gs.spec_value_id = sv.spec_value_id";
