...
public class MemberBonus {
	...
	private double min_goods_amount_ru; //最小商品卢布金额，非数据库字段
	private int use_start_date;//使用开始时间，非数据库字段
	private int use_end_date;//使用截至时间，非数据库字段
	private Integer sendplat;
	private Integer used;
	private double bonus_money_ru;//红包卢布金额，非数据库字段
	private String type_name_ru;//红包类型俄文名称名在发放时写入
	...
	public double getBonus_money_ru() {
		return bonus_money_ru;
	}
	public void setBonus_money_ru(double bonus_money_ru) {
		this.bonus_money_ru = bonus_money_ru;
	}
