...
@Results({
	 @Result(name="list",type="freemarker", location="/shop/admin/groupbuy/area/area_list.html"),
	 @Result(name="add",type="freemarker", location="/shop/admin/groupbuy/area/area_add.html"),
	 @Result(name="edit",type="freemarker", location="/shop/admin/groupbuy/area/area_edit.html")
})
