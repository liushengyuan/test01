...
@Results({
	 @Result(name="list",type="freemarker", location="/shop/admin/groupbuy/cat/cat_list.html"),
	 @Result(name="add",type="freemarker", location="/shop/admin/groupbuy/cat/cat_add.html"),
	 @Result(name="edit",type="freemarker", location="/shop/admin/groupbuy/cat/cat_edit.html")
})
