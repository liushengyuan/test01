	...
	private void sendRegEmail(Member member){
		...
		if(sms_isopen==0){
			...
			if(language.equals("zh")){
				...
				emailModel.setTitle(member.getUname()+"Здравствуйте，"+site.getSitename()+" Успешно зарегистрирован!");
				emailModel.setTemplate("reg_email_template_ru.html");
				emailModel.setEmail_type("Напоминать успешно зарегистрирован");
			}
			//emailModel.setTemplate("reg_email_template.html");
